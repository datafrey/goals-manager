...
public class YearListOfGoalsFragmentViewModel extends ListOfGoalsFragmentViewModel {

    public YearListOfGoalsFragmentViewModel(@NonNull Application application) {
        super(application);
    }
