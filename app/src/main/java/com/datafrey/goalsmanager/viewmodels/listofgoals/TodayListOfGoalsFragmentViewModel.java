...
public class TodayListOfGoalsFragmentViewModel extends ListOfGoalsFragmentViewModel {

    public TodayListOfGoalsFragmentViewModel(@NonNull Application application) {
        super(application);
    }
